...
/**
 * @argument $1 publicId e.g. james/blogs/one-stop-starter/seo-component_xpzsab
...
/**
 * @argument $1 user/reponame e.g. james/ts-nextjs-tailwind-starter
 */
...
> Originally posted on [my personal site](https://james.com/?ref=devto), find more [blog posts](https://james.com/blog?ref=devto) and [code snippets library](https://james.com/library?ref=devto) I put up for easy access on my site 🚀

Like this post? [Subscribe to my newsletter](https://james.com/subscribe?ref=devto) to get notified every time a new post is out!`;

const hashnodeFooter = `
---

> Originally posted on [my personal site](https://james.com/?ref=hashnode), find more [blog posts](https://james.com/blog?ref=hashnode) and [code snippets library](https://james.com/library?ref=hashnode) I put up for easy access on my site 🚀

Like this post? [Subscribe to my newsletter](https://james.com/subscribe?ref=hashnode) to get notified every time a new post is out!`;
//#endregion  //*======== Footers ===========
...
const devto = () => {
  ...
  readFile(fileName, 'utf8', (err, content) => {
    ...
    parsedContent = parsedContent.replace(
      CLOUDINARY_REGEXP,
      '![$2](https://res.cloudinary.com/james/image/upload/q_auto,f_auto/$1)'
    );
    parsedContent = parsedContent.replace(
      GITHUB_REGEXP,
      '{% github $1 no-readme %}'
...
const getOgImage = () => {
  readFile(fileName, 'utf8', (err, content) => {
    ...
    const bannerLink = `https://res.cloudinary.com/james/image/upload/f_auto,c_fill,ar_4:5,w_1200/james/banner/${frontmatter.banner}`;
    const ogLink = `https://og.james.link/api/blog?templateTitle=${encodeURIComponent(
      frontmatter.title
