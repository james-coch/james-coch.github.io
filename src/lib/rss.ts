...
export async function getRssXml() {
  ...
  const blogUrl = 'https://james-coch.com/blog';
  ...
  return `
    <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:blogChannel="${blogUrl}">
      <channel>
        <title>James Cochrane Blog</title>
        <link>${blogUrl}</link>
        <description>The James Cochrane Blog, thoughts, mental models, and tutorials about front-end development.</description>
